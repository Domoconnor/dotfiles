...
dssh()
{
  docker-compose exec development /bin/zsh
}

alias dualscreen='xrandr --output HDMI-2 --auto --above eDP-1'


## AUDIO 

# list inputs with pactl list-sinks
alias dragonfly='pactl set-default-sink 2'
